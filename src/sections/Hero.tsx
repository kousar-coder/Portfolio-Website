...
export const HeroSection = () => {
  return (
    <div className="py-32 md:py-48 lg:py-60 realtive z-0 overflow-x-clip"> 
    ...
    <StarIcon className="size-28 text-emerald-300" />
      ...
      <div className="container ">
        <div className="flex flex-col items-center">
          ...
          />
          <div className="bg-gray-950 border border-gray-800 px-4 py-1.5 inline-flex items-center gap-2 rounded-lg mt-4">
